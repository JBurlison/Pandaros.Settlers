...
namespace Pandaros.Settlers.Buildings.NBTReader.Core
{
    public class RegionFile : IDisposable
    {
            ...
            try {
                ...
                lock (this.fileLock)
                {
                    ...
                    if (version == VERSION_GZIP) {
                        ...
                        Stream ret = new Ionic.Zlib.GZipStream(new MemoryStream(data), CompressionMode.Decompress);
        ...
        public Stream GetChunkDataOutputStream(int x, int z)
        {
            ...
            return new ZlibStream(new ChunkBuffer(this, x, z), Ionic.Zlib.CompressionMode.Compress);
        }
        ...
        public Stream GetChunkDataOutputStream(int x, int z, int timestamp)
        {
            ...
            return new ZlibStream(new ChunkBuffer(this, x, z, timestamp), Ionic.Zlib.CompressionMode.Compress);
        }
