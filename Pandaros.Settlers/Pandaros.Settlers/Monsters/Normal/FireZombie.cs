...
namespace Pandaros.Settlers.Monsters.Normal
{
    ...
    public class FireZombie : Zombie, IPandaZombie
    {
        public static string Key = GameLoader.NAMESPACE + ".Monsters.Bosses.FireZombie";
        ...
        public FireZombie(Path path, Colony originalGoal) :
        ...
        {
            return new FireZombie(path, p);
        }


        public string name => "FireZombie";
        ...
        {
             {DamageType.Fire, 0.10f},
             {DamageType.Physical, 0.15f}
        };

        [ModLoader.ModCallback(ModLoader.EModCallbackType.AfterItemTypesDefined,  GameLoader.NAMESPACE + ".Monsters.Normal.FireZombie.Register")]
        ...
        public static void Register()
        {
            var m = new JSONNode()
                   .SetAs("keyName", Key)
                   .SetAs("printName", "Fire Zombie")
                   .SetAs("npcType", "monster");

            var ms = new JSONNode()
                    .SetAs("albedo", GameLoader.BLOCKS_NPC_PATH + "Fire_monster.png")
