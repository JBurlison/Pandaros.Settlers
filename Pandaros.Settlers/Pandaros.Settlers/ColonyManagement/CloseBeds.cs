...
//            bso.Colony = colony;
//            colony.BedTracker .Foreach(ForEachAction, ref bso);
...
//        public int CalculateBedCountNearBanners(Colony colony, BannerTracker.Banner[] banners)
//        {
//            if (banners == null || banners.Length == 0)
//            {
//                return 0;
//            }
//            Pipliz.Collections.SortedList<Vector3Int, BedChunk> BedChunks = colony.BedTracker.GetFieldValue<Pipliz.Collections.SortedList<Vector3Int, BedChunk>, ColonyBeds>("BedChunks");
//            HashSet<int> ColonyLessDeduplicator = colony.BedTracker.GetFieldValue<HashSet<int>, ColonyBeds>("ColonyLessDeduplicator");

//            if (BedChunks.Count != 0)
//            {
//                int exclusiveRadius = ServerManager.ServerSettings.Colony.ExclusiveRadius;
//                lock (BedChunks)
//                {
//                    lock (ColonyLessDeduplicator)
//                    {
//                        ColonyLessDeduplicator.Clear();
//                        foreach (BannerTracker.Banner banner in banners)
//                        {
//                            Vector3Int position = banner.Position - exclusiveRadius;
//                            Vector3Int position2 = banner.Position + exclusiveRadius;
//                            Vector3Int vector3Int = ToChunkCorner(position);
//                            Vector3Int vector3Int2 = ToChunkCorner(position2);
//                            for (int j = vector3Int.x; j <= vector3Int2.x; j += 64)
//                            {
//                                for (int k = vector3Int.y; k <= vector3Int2.y; k += 64)
//                                {
//                                    for (int l = vector3Int.z; l <= vector3Int2.z; l += 64)
//                                    {
//                                        Vector3Int key = new Vector3Int(j, k, l);
//                                        if (BedChunks.Contains(key, out int foundIndex))
//                                        {
//                                            ColonyLessDeduplicator.Add(foundIndex);
//                                        }
//                                    }
//                                }
//                            }
//                        }
//                        int num = 0;
//                        foreach (int item in ColonyLessDeduplicator)
//                        {
//                            num += BedChunks.ValsRaw[item].CalculateInRange(BedChunks.KeysRaw[item], banners, exclusiveRadius);
//                        }
//                        return num;
//                    }
//                }
