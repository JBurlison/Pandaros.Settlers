...
{
    public class SkilledChest2Recipe : ICSRecipe
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledChest2Recipe";
        ...
        public Dictionary<ItemId, int> Requirements { get; set; } = new Dictionary<ItemId, int>()
        {
            ...
            { ItemId.GetItemId("Pandaros.Settlers.SkilledChest1"), 1 }
        };

        public Dictionary<ItemId, int> Results { get; set; } = new Dictionary<ItemId, int>()
        {
            { ItemId.GetItemId(SkilledChest2.NAME), 1 }
        };
    ...
    public class SkilledChest2 : CSType, IArmor, IPlayerMagicItem
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledChest2";
        ...
        public override string icon { get; set; } = GameLoader.ICON_PATH + "SkilledChest2.png";
