...
{
    public class SkilledBoots2Recipe : ICSRecipe
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledBoots2Recipe";
        ...
        public Dictionary<ItemId, int> Requirements { get; set; } = new Dictionary<ItemId, int>()
        {
            ...
            { ItemId.GetItemId("Pandaros.Settlers.SkilledBoots1"), 1 }
        };

        public Dictionary<ItemId, int> Results { get; set; } = new Dictionary<ItemId, int>()
        {
            { ItemId.GetItemId(SkilledBoots2.NAME), 1 }
        };
    ...
    public class SkilledBoots2 : CSType, IArmor, IPlayerMagicItem
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledBoots2";
        ...
        public override string icon { get; set; } = GameLoader.ICON_PATH + "SkilledBoots2.png";
