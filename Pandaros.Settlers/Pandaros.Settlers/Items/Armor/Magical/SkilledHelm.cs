...
{
    public class SkilledHelmRecipe : ICSRecipe
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledHelmRecipe";
        ...
        public Dictionary<ItemId, int> Requirements { get; set; } = new Dictionary<ItemId, int>()
        {
            ...
            { ItemId.GetItemId("Pandaros.Settlers.SteelHelm"), 1 }
        };

        public Dictionary<ItemId, int> Results { get; set; } = new Dictionary<ItemId, int>()
        {
            { ItemId.GetItemId(SkilledHelm.NAME), 1 }
        };
    ...
    public class SkilledHelm : CSType, IArmor, IPlayerMagicItem
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledHelm";
        ...
        public override string icon { get; set; } = GameLoader.ICON_PATH + "SkilledHelm.png";
