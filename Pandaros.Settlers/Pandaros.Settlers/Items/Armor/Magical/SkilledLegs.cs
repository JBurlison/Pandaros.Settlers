...
{
    public class SkilledLegsRecipe : ICSRecipe
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledLegsRecipe";
        ...
        public Dictionary<ItemId, int> Requirements { get; set; } = new Dictionary<ItemId, int>()
        {
            ...
            { ItemId.GetItemId("Pandaros.Settlers.SteelLegs"), 1 }
        };

        public Dictionary<ItemId, int> Results { get; set; } = new Dictionary<ItemId, int>()
        {
            { ItemId.GetItemId(SkilledLegs.NAME), 1 }
        };
    ...
    public class SkilledLegs : CSType, IArmor, IPlayerMagicItem
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledLegs";
        ...
        public override string icon { get; set; } = GameLoader.ICON_PATH + "SkilledLegs.png";
