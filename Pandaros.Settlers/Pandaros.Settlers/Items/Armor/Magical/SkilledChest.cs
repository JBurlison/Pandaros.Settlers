...
{
    public class SkilledChestRecipe : ICSRecipe
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledChestRecipe";
        ...
        public Dictionary<ItemId, int> Requirements { get; set; } = new Dictionary<ItemId, int>()
        {
            ...
            { ItemId.GetItemId("Pandaros.Settlers.SteelChest"), 1 }
        };

        public Dictionary<ItemId, int> Results { get; set; } = new Dictionary<ItemId, int>()
        {
            { ItemId.GetItemId(SkilledChest.NAME), 1 }
        };
    ...
    public class SkilledChest : CSType, IArmor, IPlayerMagicItem
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledChest";
        ...
        public override string icon { get; set; } = GameLoader.ICON_PATH + "SkilledChest.png";
