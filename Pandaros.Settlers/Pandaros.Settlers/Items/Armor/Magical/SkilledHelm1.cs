...
{
    public class SkilledHelm1Recipe : ICSRecipe
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledHelm1Recipe";
        ...
        public Dictionary<ItemId, int> Requirements { get; set; } = new Dictionary<ItemId, int>()
        {
            ...
            { ItemId.GetItemId("Pandaros.Settlers.SkilledHelm"), 1 }
        };

        public Dictionary<ItemId, int> Results { get; set; } = new Dictionary<ItemId, int>()
        {
            { ItemId.GetItemId(SkilledHelm1.NAME), 1 }
        };
    ...
    public class SkilledHelm1 : CSType, IArmor, IPlayerMagicItem
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledHelm1";
        ...
        public override string icon { get; set; } = GameLoader.ICON_PATH + "SkilledHelm1.png";
