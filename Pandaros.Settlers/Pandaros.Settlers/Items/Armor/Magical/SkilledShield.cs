...
{
    public class SkilledShieldRecipe : ICSRecipe
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledShieldRecipe";
        ...
        public Dictionary<ItemId, int> Requirements { get; set; } = new Dictionary<ItemId, int>()
        {
            ...
            { ItemId.GetItemId("Pandaros.Settlers.SteelShield"), 1 }
        };

        public Dictionary<ItemId, int> Results { get; set; } = new Dictionary<ItemId, int>()
        {
            { ItemId.GetItemId(SkilledShield.NAME), 1 }
        };
    ...
    public class SkilledShield : CSType, IArmor, IPlayerMagicItem
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledShield";
        ...
        public override string icon { get; set; } = GameLoader.ICON_PATH + "SkilledShield.png";
