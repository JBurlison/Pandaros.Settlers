...
{
    public class SkilledGloves2Recipe : ICSRecipe
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledGloves2Recipe";
        ...
        public Dictionary<ItemId, int> Requirements { get; set; } = new Dictionary<ItemId, int>()
        {
            ...
            { ItemId.GetItemId("Pandaros.Settlers.SkilledGloves1"), 1 }
        };

        public Dictionary<ItemId, int> Results { get; set; } = new Dictionary<ItemId, int>()
        {
            { ItemId.GetItemId(SkilledGloves2.NAME), 1 }
        };
    ...
    public class SkilledGloves2 : CSType, IArmor, IPlayerMagicItem
    {
        public static string NAME = GameLoader.NAMESPACE + ".SkilledGloves2";
        ...
        public override string icon { get; set; } = GameLoader.ICON_PATH + "SkilledGloves2.png";
